...
<div class="padre">
    ...
    <div class="panel">
        <div class="contenido-panel">
            <div class="row">
                <div class="col2">
                    <a class="aa" href="registro_grados.php">
                        <div class="boton">
                            <img class="icono" src="./img/aña.png" alt="">
                            <p class="separador">Registro de grados</p>
                        </div>
                    </a>
                </div>
                <div class="col2">
                    <a class="aa" href="registro_subgrados.php">
                        <div class="boton">
                            <img class="icono" src="./img/aña.png" alt="">
                            <p class="separador">Registro de subgrados</p>
                        </div>
                    </a>
                </div>
                <div class="col2">
                    <a class="aa" href="listado_grados_sub.php">
                        <div class="boton">
                            <img class="icono" src="./img/file.png" alt="">
                            <p class="separador">listado de grados y subgrados</p>
                        </div>
                    </a>
                </div>
                <div class="col2">
