...
<div class="padre">
    ...
    <div class="panel">
        <div class="contenido-panel">
            <div class="row">
                <div class="col2">
                    <a class="aa" href="listado_alumno.php">
                        <div class="boton">
                            <img class="icono" src="./img/file.png" alt="">
                            <p class="separador">Listado de alumnos</p>
                        </div>
                    </a>
                </div>
                <div class="col2">
                    <a class="aa" href="listado_profesores.php">
                        <div class="boton">
                            <img class="icono" src="./img/file.png" alt="">
                            <p class="separador">Listado de maestros</p>
                        </div>
                    </a>
                </div>
                <div class="col2">
                    <a class="aa" href="listado_admin.php">
                        <div class="boton">
                            <img class="icono" src="./img/file.png" alt="">
                            <p class="separador">listado de administradores</p>
                        </div>
                    </a>
                </div>
                <div class="col2">
