...
<body>
    <div class="padre">
        ...
        <div class="panel">
            ...
            <div class="row">
                    <div class="col2">
                        <a class="aa" href="registro_profesores.php">
                            <div class="boton">
                                <img class="icono" src="./img/docen.png" alt="">
                                <p class="separador">añadir profesores</p>
                            </div>
                        </a>
                    </div>
                    <div class="col2">
                        <a class="aa" href="registro_estudiantes.php">
                            <div class="boton">
                                <img class="icono" src="./img/estu.png" alt="">
                                <p class="separador">añadir estudiantes</p>
                            </div>
                        </a>
                    </div>
                    <div class="col2">
                        <a class="aa" href="registro_admin.php">
                            <div class="boton">
                                <img class="icono" src="./img/docen.png" alt="">
                                <p class="separador">añadir administrador</p>
                            </div>
                        </a>
                    </div>
                    <div class="col2">
                        <a class="aa" href="registro_padres.php">
                            <div class="boton">
                                <img class="icono" src="./img/padres.png" alt="">
                                <p class="separador">añadir padres de familia</p>
                            </div>
                        </a>
                    </div>
                </div>
