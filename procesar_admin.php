<?php
    ...
    if (isset($_POST['guardar'])) {
        ...
        try {
            ...
            $stmtLogin = $conn->prepare("INSERT INTO login (usuario_login, password_login, rol_login) VALUES (:usuario, :clave, 'Administrador')");
            ...
            $stmtMaestro = $conn->prepare("INSERT INTO administradores (nombres_admin, apellidos_admin, cedula_admin, genero_admin, login_admin) VALUES (:nombres, :apellidos, :cedula, :genero, :login_id)");
            ...
            header("Location: registro_admin.php?info=success");
            exit();
            ...
            header("Location: registro_admin.php?err=error");
            exit();
        }
